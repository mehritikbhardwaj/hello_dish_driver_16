...
//
//     final homeAllOrder = homeAllOrderFromJson(jsonString);

import 'dart:convert';

HomeAllOrder homeAllOrderFromJson(String str) => HomeAllOrder.fromJson(json.decode(str));

String homeAllOrderToJson(HomeAllOrder data) => json.encode(data.toJson());
...
class HomeAllOrder {
  ...
  factory HomeAllOrder.fromJson(Map<String, dynamic> json) => HomeAllOrder(
    status: json["status"],
...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
    ...
    customerLocationId: CustomerLocationId.fromJson(json["customerLocationId"]),
...
class CustomerLocationId {
  ...
  factory CustomerLocationId.fromJson(Map<String, dynamic> json) => CustomerLocationId(
    id: json["_id"],
