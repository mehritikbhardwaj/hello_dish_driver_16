    ...
    return Scaffold(
      body: SafeArea(
        child: GetBuilder<OrderController>(
            builder: (c) {
              if(c.allOrderList.toString()!='null') {
                return Container(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        if (c.allOrderList!.value.data[index].cancelStatus == 1) {
...
cancelOrderCard(onPressed,quantity,item,price,imgUrl,orderPrice,createdAt) {
  return Column(
    crossAxisAlignment: CrossAxisAlignment.start,
    children: [
      Row(
